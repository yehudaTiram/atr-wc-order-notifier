 ...
 */
class Atr_Wc_Order_Notifier_Admin {
	...
	public function enqueue_scripts() {
		//wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/atr-wc-order-notifier-admin.js', array( 'jquery' ), $this->version, false );
	}
	...
	private function load_dependencies()
	{
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path(dirname(__FILE__)) .  'admin/class-atr-wc-order-notifier-settings.php';
	}
